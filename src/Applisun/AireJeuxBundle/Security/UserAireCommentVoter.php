...
class UserAireCommentVoter implements VoterInterface
{
    /**
    ...
    {
        return 'USER_CAN_COMMENT' == $attribute;
    }
    ...
    */
    public function vote(TokenInterface $token, $object, array $attributes)
    {
        ...
        // attribut supporté et object supporté, donc on vérifie si l'utilisateur peut commenter sur l'aire
        return $object->hasUserAlreadyCommented($user) ? self::ACCESS_DENIED : self::ACCESS_GRANTED;
    }
}
